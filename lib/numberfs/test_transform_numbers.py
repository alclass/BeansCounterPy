...
Mainly it pandasfs the European number representation (dots for thousands and comma for decimal places)
  into Python's American-like format (just the dot for decimal place)
"""
import unittest
import lib.numberfs.transform_numbers as trans  # .transform_european_stringnumber_to_pythonfloat
