...
from lib.numberfs.transform_numbers import transform_european_stringnumber_to_pythonfloat
...
class BBExtractScraperWithFileText(fAplic.FundoAplic):
  ...
  def find_saldo_ant_n_cotas(self):
    ...
    if findall:
      ...
      nextstr_to_extract_for_values = ptuple[-1]  # on this will be applied the next regex.findall()
