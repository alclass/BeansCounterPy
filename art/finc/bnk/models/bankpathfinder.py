#!/usr/bin/env python3
"""
models/models/bankpathfinder.py
"""
import inspect
import os.path
import lib.datesetc.datehilofs as hilodt
import art.finc.bnk.models.bankpropsmod as bkmd  # .BankProps

import art.finc.bnk.models.bank_data_settings as bdsett  # bdsett.BankProps.BANKBASEFOLDERPATHS
import art.finc.bnk.models.banksgeneral as bkgen  # bkgen.BANK
# import fs.osfs.dirtree_dateprefixed2 as prfx2  # prfx.FolderNodeForDatePrefixTree
# import fs.osfs.oshilofunctions as hilo
import os.discoverers.dateprefixdisconverers.dateprefixed_dirtree_finder as prfx
...
class BankOSFolderFileFinder:
  ...
  def create_l1yyyyfolderpath_by_year_opt_substr(self, year, substr=None):
    ...
    _ = substr
    basefolderpath = self.prxfinder.rootfolderpath
