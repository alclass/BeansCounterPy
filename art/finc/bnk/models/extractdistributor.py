...
extractdistributor.py
  Chooses function/method for calling depending upon which bnk function/method calling it related.
...
"""
import art.finc.bnk.models.banksgeneral as bkgen  # contains BANK which is mostly a static/classmethod class
import art.finc.bnk.models.cef.extractCefFiDataFromXml as extrCef
import art.finc.bnk.models.bb.fi.bbScraperWithFileText as extrBB
