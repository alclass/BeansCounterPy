...
to_corretc_list_triple_rends_from_db.py
  lists the triples rends, ie no mês, no ano, nos últimos 12 meses, on bnk and refmonth range.
...
import datetime
import sys
# where is the filefinder module?
# import art.finc.bnk.db..db.dbasfolder.find_dateprefixedfiles_fr_basefolder as find
import lib.datesetc.datefs as dtfs
import art.finc.bnk.models.extractdistributor as extrdistr
...
class TripleRendLister:
  ...
  def fetch_month_triplerend(self, refmonth):
    year = refmonth.year
    yearfolderpath = self.bankpathdiscoverer.find_or_create_l1yyyyfolderpath_by_year_opt_substr(year)
