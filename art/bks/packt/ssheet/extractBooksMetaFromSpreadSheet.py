...
art/bookroutes/packt/ssheet/extractBooksMetaFromSpreadSheet.py
  Extracts metadata from Packt's (selected/owned) bookroutes from a spreadsheet (Calc or Excel via pandas)
  previously:
...
from art.bks.packt.models.BookModel import BookInfoDC
