#!/usr/bin/env python3
"""
art/bookroutes/show_excel_fillup_progress_of_packt_isbns.py
...
import os
import pandas as pd
import art.bks.packt.ssheet.functions_packt_books_data_excel_json_pandas as bkfs  # bkfs.get_bookdata_dirpath
import art.bks.packt.ssheet.functions_dataframe as dffs  # dffs.extract_rows_that_have_at_least_one_na
