#!/usr/bin/env python3
"""
art/bookroutes/packt/folders/writeBooksCollectionJsonFile.py
  Explanation:
    (...)
...
import os
import sys
import art.bks.packt.folders.packtInfoDirTreeExtractor as pIDT
...
class GenerateJsonCollection:
  ...
  def writefile_jsoncollection_w_stored(self):
    ...
    print(scrmsg)
    scrmsg = f"Number of bookroutes: {len(dictlist)}"
    print(scrmsg)
