#!/usr/bin/env python3
"""
art/bookroutes/packt/knowledgeArea.py
import regex
from xxlimited_35 import Null
from art.bookroutes.packt import PACKT_URL_TO_INTERPOL
"""
from dataclasses import dataclass, asdict
import art.bks.packt.models.wordTranslateDict as wTD  # wtd.transdict
...
def cleanup(word):
  ...
  try:
    if word.endswith(' Bks'):
      word = word[:-4]
    # evens = [0 if x % 2 == 0 else -1 for x in numberfs]
