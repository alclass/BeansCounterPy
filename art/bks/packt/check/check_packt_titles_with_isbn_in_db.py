#!/usr/bin/env python3
"""
art/bookroutes/packt/check_packt_titles_with_isbn_in_db.py
"""
import os
import glob
import pandas as pd
import settings as sett
import art.bks as init  # init.GOOGLE_URL_API_interpol
pd.set_option('display.max_rows', 100)
GOOGLE_URL_API_interpol  = init.GOOGLE_URL_API_interpol
...
class ISBNLister:
  ...
  def dataframe_postread_cleanup(self):
    ...
    colindices = list(range(0, self.N_COLUMNS))  # 3
