#!/usr/bin/env python3
"""
art/bookroutes/packt/mongo/syncKnowledgeareaFrSsheetToMongocoll.py
...
from art.bks.packt.mongo.retrievers.formBookUrlsFromKAreasInMongoCollection import MongoDBCollReader
