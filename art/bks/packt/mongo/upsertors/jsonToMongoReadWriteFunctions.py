#!/usr/bin/env python3
"""
art/bookroutes/packt/folders/jsonToMongoReadWriteFunctions.py
  older/previous: art/bookroutes/packt/mongo/writeMongodbFunctions.py
  Explanation?
    (...)
...
def from_jsondictlist_to_mongodb_advanced(
  ...
  try:
    ...
    scrmsg += f"(The folders provided the bookroutes meta information for the MongoDB collection.)\n"
    print(scrmsg)
