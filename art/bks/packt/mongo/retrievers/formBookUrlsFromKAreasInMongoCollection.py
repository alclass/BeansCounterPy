#!/usr/bin/env python3
"""
art/bookroutes/packt/mongo/retrievers/formBookUrlsFromKAreasInMongoCollection.py
  forms book URL's from the Knowledge Area field in Mongo Collection

import json
from pymongo import MongoClient
from art.bookroutes.packt.BookModel import BookInfoDC
"""
...
class KAreaURLFormer:
  ...
  def __str__(self):
    outstr = f"""{self.__class__.__name__}
      total bookroutes in db = {self.dbretriever.total_books}
