#!/usr/bin/env python3
"""
art/bookroutes/packt/mdb/checkIsbnsFilesAgainstMongo.py
...
"""
import art.bks.packt.mdb.retrievers.formBookUrlsFromKAreasInMongoCollection as rBFM  # rbfm.MongoDBCollReader
