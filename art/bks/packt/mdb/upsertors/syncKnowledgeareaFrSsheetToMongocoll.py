#!/usr/bin/env python3
"""
art/bookroutes/packt/mdb/syncKnowledgeareaFrSsheetToMongocoll.py
...
from art.bks.packt.mdb.retrievers.formBookUrlsFromKAreasInMongoCollection import MongoDBCollReader
...
class SyncKAreaFromSSheetToMongoColl:
  ...
  def mongo_insert(self, bookinfo):
    print('@mongo_insert')
    self.n_inserted += 1
    result = self.mongocoll.insert_one(bookinfo.to_json)
