...
import lib.dbfs.dbasfolder.bankFoldersDiscover as bankFoldersDisc
...
class Insertor:
  ...
  Obs: in this list below becomes outdated in this comment,
     remember that it is autogenerated (from class FundoAplic) from the programs themselves

  fieldnames = [
    'bank3letter', 'refmonthdate', 'name', 'cnpj', 'data_saldo_ant', 'saldo_anterior',
    'qtd_cotas_ant', 'valor_cota_ant',
    'data_saldo_atu', 'saldo_atual', 'qtd_cotas_atu', 'valor_cota_atu',
    'prct_rend_mes',
  ...
  def read_daterange_records(self):
    ...
    # roller has list [fundo_result_records] which contains the sought-for testdata
