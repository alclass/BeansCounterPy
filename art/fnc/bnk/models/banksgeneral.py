#!/usr/bin/env python3
"""
art/fnc/bnk/pdntcmdls/banksgeneral.py

"""
import os
from lib.osfs import filefolder_retriever_fs as osfs
import lib.dbfs.dbasfolder.find_dateprefixedfiles_fr_basefolder as lookup
...
class GenBank:
  ...
  def get_bank_fi_folderpath_by_its3letter(cls, bank3letter):
    ...
    entries = osfs.retrieve_foldernames_from_basefolderpath(folderpath)
  ...
  def mount_text_list_available_banks(cls):
    """
    lists all bnk registers here (*) available :: (*) here means "directery in this module or in settings.py"
