#!/usr/bin/env python3
"""
art/bnk/pydantmodels/bb/fi/fibb_daily_results_numbers_comma_to_point_convert.py
...
import lib.texts.regex.refunctions as decpla
...
import art.finc.bnk.models.bankpathfinder as pthfnd  # .BankOSFolderFileFinder
import art.finc.bnk.models.bb.fi.fibb_daily_results_html_to_csv_via_pandas_transform as trnsf  # WithPandasHtmlToCsvConverter
    ...
    if self.output_filepath is None:
      ...
      try:
        ...
        if not os.path.isdir(output_folderpath):
          ...
          osfs.makedirs(output_folderpath)
      except OSError:
        self.set_conventioned_output_filepath()
