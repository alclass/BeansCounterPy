...
bankFoldersDiscover.py
  envolopes module find_dateprefixedfiles_fr_basefolder.py giving it BBFI's basefolder
"""
import os
import pdfquery
import lib.dbfs.dbasfolder.find_dateprefixedfiles_fr_basefolder as fndr
...
def xmltransform_all_data_years():
  ...
  # roll all available testdata years
