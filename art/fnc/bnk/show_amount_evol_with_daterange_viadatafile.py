...
show_amt_evol_wi_daterange_viadb.py
  prints to stdout a report with triple rends (no mês, no ano, últimos 12 meses) for all pdntcmdls with a date range
  (this script searches via db [there's another version that searches via testdata files])
"""
import sys
