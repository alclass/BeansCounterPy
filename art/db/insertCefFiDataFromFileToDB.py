...
import lib.db.dbasfolder.lookup_monthrange_convention_from_basedatafolder_on as lkup  # for finding "conventioned" paths
import lib.os.oshilofunctions as hilo  # for recuperating refmonth from str
