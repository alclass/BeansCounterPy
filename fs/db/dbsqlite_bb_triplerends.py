...
SQLITE_FILENAME = 'bb_triplerends_db'
tablename = 'bb_triplerends'
...
class SqliteBBTripleRend:
  ...
  def db_create_table(self):
    ...
    CREATE TABLE IF NOT EXISTS rentabfundos (
      ...
      refmonthdate DATE,
      cnpj TEXT,
      prct_rend_mes DECIMAL,
      prct_rend_desdeano DECIMAL,
      prct_rend_12meses DECIMAL
    )
    '''
    conn = self.get_connection()
