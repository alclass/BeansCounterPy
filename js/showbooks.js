...
// Get all books (sorted by creation date by default)
  ...
  res.send(`
    ...
    <script>
      ...
      function renderTable() {
        if (!booksData.length) {
          tableBody.innerHTML = '<tr><td colspan="6" class="empty-row">No books found. Add a book to get started!</td></tr>';
          return;
        }
      ...
      async function fetchBooks() {
        try {
          ...
          console.error(err);
          tableBody.innerHTML = '<tr><td colspan="6" class="empty-row">Error loading books. Is the server running?</td></tr>';
        }
      }
